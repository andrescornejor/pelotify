-- PLAYER ELO LOSS PENALTY & PERFORMANCE BALANCING
-- This script updates the match finalization logic to include a penalty for losses
-- and ensures player ELO reflects both individual performance and match outcome.
...
BEGIN
    ...
    LOOP
        ...
        -- Apply updates to profile (with floor logic to prevent negative total elo handled by constraint)
