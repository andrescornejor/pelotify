                        ...
                        >
                            ...
                            <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); handleNext(); }}>
                                <motion.div variants={itemVariants} className="space-y-2">
                                    <label className="text-[10px] font-black uppercase text-foreground/60 tracking-widest pl-4">El Nombre de la Leyenda</label>
                                    <input
                                        type="text"
                                        required
                                        value={formData.name}
                                ...
                                <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase text-foreground/60 tracking-widest pl-4">Edad (Años)</label>
                                        <input
                                            type="number"
                                            required
                                            value={formData.age}
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase text-foreground/60 tracking-widest pl-4">Altura (cm)</label>
                                        <input
                                            type="number"
                                            required
                                ...
                                <motion.div variants={itemVariants} className="space-y-2">
                                    <label className="text-[10px] font-black uppercase text-foreground/60 tracking-widest pl-4">Pie Dominante</label>
                    ...
                    {step === 1 && (
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    { id: 'POR', title: 'Portero', icon: Shield, color: 'text-blue-400', glow: 'hover:shadow-[0_0_30px_rgba(96,165,250,0.2)] hover:border-blue-400/50 block-glow-blue' },
                                    ...
                                    >
                                        ...
                                        <Icon className={cn("w-10 h-10 transition-transform group-hover:scale-110", color)} />
