...
export default function RanksPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-32">
      {/* Header */}
      <header className="sticky top-0 z-50 glass-premium border-b border-foreground/5 py-6 px-3 sm:px-5 lg:px-10 xl:px-16">
      ...
      <main className="max-w-full mx-auto px-3 sm:px-5 lg:px-10 xl:px-16 py-12 space-y-24">
        {/* Intro Section */}
