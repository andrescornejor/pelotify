            ...
            <main className="max-w-screen-xl mx-auto px-4 py-12 space-y-24">
                ...
                <section className="space-y-12">
                    <div className="flex items-center gap-4">
                        <h2 className="text-2xl font-black italic uppercase tracking-tighter">Divisiones de la Liga</h2>
                ...
                <section id="leaderboard" className="space-y-12 scroll-mt-32">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="h-px flex-1 bg-foreground/5" />
                        <span className="text-[10px] font-black text-primary uppercase tracking-[0.3em]">Top 10 Jugadores</span>
                    </div>
                                ...
                                <table className="w-full border-collapse">
                                    <thead>
                                        <tr className="border-b border-foreground/5 bg-foreground/[0.02]">
                                            <th className="px-8 py-6 text-left text-[10px] font-black uppercase tracking-[0.3em] text-foreground/30">Pos</th>
                                            <th className="px-8 py-6 text-left text-[10px] font-black uppercase tracking-[0.3em] text-foreground/30">Jugador</th>
                                            <th className="px-8 py-6 text-center text-[10px] font-black uppercase tracking-[0.3em] text-foreground/30">Rango</th>
                                            <th className="px-8 py-6 text-center text-[10px] font-black uppercase tracking-[0.3em] text-foreground/30">Partidos</th>
                                            <th className="px-8 py-6 text-right text-[10px] font-black uppercase tracking-[0.3em] text-foreground/30">Puntos XP</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                ...
                                                >
                                                    <td className="px-8 py-6">
                                                        <div className={cn(
                                                            ...
                                                            isTop3 ? `${colors[idx]} bg-foreground/5 border border-current shadow-[0_0_15px_rgba(0,0,0,0.2)]` : "text-foreground/20"
                                                        )}>
                                                            #{idx + 1}
                                                        </div>
                                                    </td>
                                                    <td className="px-8 py-6">
                                                        <div className="flex items-center gap-4">
                                                            <div className="relative">
                                                                ...
                                                                />
                                                                {isTop3 && (
                                                                    <div className={cn("absolute -top-1 -right-1 w-4 h-4 rounded-full border-2 border-background", idx === 0 ? "bg-yellow-400" : idx === 1 ? "bg-slate-300" : "bg-amber-600")} />
                                                                )}
                                                            </div>
                                                            <div className="flex flex-col gap-0.5">
                                                                <span className="font-black italic uppercase tracking-tighter text-foreground group-hover:text-primary transition-colors text-lg">{player.name}</span>
                                                                <span className="text-[9px] font-black uppercase tracking-widest text-foreground/40">{player.position}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td className="px-8 py-6">
