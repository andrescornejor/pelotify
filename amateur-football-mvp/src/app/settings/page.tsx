          ...
          <div className="glass-premium p-4 rounded-[2rem] border border-foreground/5 space-y-3">
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center border transition-all ${performanceMode ? 'bg-primary/20 border-primary/20 shadow-[0_0_20px_rgba(16,185,129,0.2)]' : 'bg-foreground/5 border-foreground/10'}`}
                >
                  {performanceMode ? (
              ...
              <div
                className={`w-12 h-6 rounded-full relative transition-all duration-300 border ${performanceMode ? 'bg-primary border-primary' : 'bg-foreground/10 border-foreground/5'}`}
              >
                <motion.div
