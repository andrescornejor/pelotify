...
export default function FriendsPage() {
  ...
  return (
    <div className="flex flex-col min-h-[90vh] bg-background p-4 sm:p-6 lg:px-6 lg:pt-4 xl:px-10 max-w-full mx-auto space-y-8 relative overflow-hidden">
      {/* ── AMBIENT GLOWS ── */}
      ...
      {/* ── QUICK STATS ── */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 px-4 w-full relative z-20">
