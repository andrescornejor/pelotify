...
export default function FriendsPage() {
  ...
  return (
    <div className="flex flex-col min-h-[90vh] bg-background px-4 pt-4 sm:px-6 sm:pt-6 lg:px-6 lg:pt-4 xl:px-10 max-w-full mx-auto space-y-8 relative overflow-hidden">
      {/* ── AMBIENT GLOWS ── */}
