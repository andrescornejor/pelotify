  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[100dvh] p-4 lg:p-8 relative overflow-hidden bg-background">
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle at 50% 50%, ${formData.secondaryColor}22 0%, ${formData.primaryColor}11 50%, transparent 100%)`,
        }}
      />
          ...
          <div className="absolute top-0 right-10">
            {logoPreview && (
              <motion.div
                ...
                className="w-24 h-24 rounded-full border-4 border-background bg-surface shadow-2xl overflow-hidden"
              >
              ...
              {step === 2 && (
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {COLORS.map((c) => (
                        <button
                          ...
                          className={cn(
                            'w-10 h-10 rounded-full border-2 transition-all',
                            formData.secondaryColor === c.value
                              ? 'border-foreground scale-110'
                              : 'border-transparent opacity-50 hover:opacity-100 hover:scale-105'
                          )}
                          style={{ backgroundColor: c.value }}
                  ...
                  <div className="flex gap-4">
                    <button
                      onClick={prevStep}
                      className="w-16 h-16 bg-foreground/[0.03] border border-foreground/5 rounded-2xl flex justify-center items-center"
                    >
                      <ChevronLeft />
                    </button>
                    <button
              ...
              {step === 3 && (
                ...
                >
                  <div className="flex flex-col items-center py-6 border-2 border-dashed border-foreground/10 rounded-3xl relative overflow-hidden group">
                    {logoPreview && (
                      <div className="absolute inset-0 z-0 opacity-20 blur-xl px-10">
                        <img src={logoPreview} className="w-full h-full object-cover" />
                      </div>
                    )}
                    ...
                    <label className="relative z-10 cursor-pointer flex flex-col items-center gap-4">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-[10px] uppercase font-bold text-foreground/40 mt-1">
                          PNG o JPG cuadriculado
                        </p>
                      </div>
                      <input
                        type="file"
                  ...
                  <div className="p-4 rounded-2xl bg-foreground/[0.03] border border-foreground/5 space-y-2">
                    <p className="text-[10px] font-bold text-foreground/50 uppercase tracking-widest text-center leading-relaxed">
                      Al fundar el club, serás el{' '}
                      <span className="text-primary font-black">CAPITÁN ABSOLUTO</span>.<br />{' '}
                      Podrás invitar jugadores y aceptar retos.
                    </p>
                  </div>
                    ...
                    >
                      ...
                      <span className="relative z-10 flex gap-2 items-center">
                        {isLoading ? (
                          ...
                          <>
                            <CheckCircle2 className="w-5 h-5" /> Establecer Club
                          </>
                        )}
                      </span>
                    </button>
