...
function ProfileContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background relative selection:bg-primary/30 selection:text-primary overflow-x-hidden">
      ...
      <div className="max-w-screen-2xl mx-auto w-full px-4 sm:px-6 lg:px-12 -mt-24 sm:-mt-32 lg:-mt-40 relative z-20 pb-20">
        ...
        <div className="sticky top-0 z-40 bg-background/80 backdrop-blur-xl border-y border-foreground/10 mb-10 -mx-4 px-4 sm:mx-0">
           <div className="flex items-center justify-center sm:justify-start gap-10 py-5 overflow-x-auto no-scrollbar max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-12">
              {[
                            ...
                            >
                              <div className="shrink-0 w-14 h-14 rounded-2xl bg-foreground/5 overflow-hidden border border-foreground/10 group-hover:border-primary/20 transition-colors">
                                {comment.author?.avatar_url ? (
                                  ...
                                  <div className="w-full h-full flex items-center justify-center text-[10px] font-black text-foreground/20 italic">
                                    Player
                                  </div>
                                )}
                              </div>
                    ...
                    <div className="lg:col-span-5 xl:col-span-4 order-1 lg:order-2">
                      <div className="lg:sticky lg:top-24 space-y-8">
                        ...
                        <div className="glass-premium p-8 rounded-[3rem] border border-foreground/10 space-y-6 relative overflow-hidden group/header text-center lg:text-left">
                          ...
                          <div className="space-y-1">
                            <h3 className="text-3xl font-black italic text-foreground uppercase tracking-tighter leading-tight">
                              Muro de <span className="text-primary">Honor</span>
                            </h3>
                            <p className="text-[10px] font-black uppercase text-foreground/40 tracking-[0.3em] leading-relaxed">
                              Deja un mensaje para la posteridad en el perfil de este jugador.
                            </p>
                          </div>
                        </div>
                        ...
                        {user && (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-4 mb-2">
                              ...
                              <div className="flex flex-col">
                                <span className="text-[10px] font-black uppercase tracking-widest text-foreground/60 italic leading-none">
                                  Publicar como
                                </span>
                                <span className="text-sm font-black text-primary italic uppercase tracking-tight">
                                  {user.name}
                                </span>
                              </div>
                            </div>
