...
export default function TeamsPage() {
    ...
    return (
        <div className="flex flex-col gap-8 p-4 sm:p-6 lg:px-10 lg:pt-4 xl:px-14 2xl:px-16 max-w-screen-2xl mx-auto min-h-screen bg-background relative overflow-hidden">
            {/* Ambient Effects */}
