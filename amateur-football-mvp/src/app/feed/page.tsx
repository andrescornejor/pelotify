        ...
        <div className="flex gap-0 lg:gap-6 xl:gap-8">
          ...
          <div className="w-full lg:flex-1 border-x border-foreground/[0.06] min-h-screen flex flex-col relative z-10">
            ...
            <div 
               ...
               className="sticky top-[80px] z-50 bg-background border-b border-foreground/[0.06] px-5 py-3 flex items-center justify-between cursor-pointer active:opacity-80 transition-opacity"
            >
