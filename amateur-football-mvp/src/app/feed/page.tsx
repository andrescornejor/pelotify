...
export default function FeedPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col min-h-screen bg-background pt-[82px] px-3 sm:px-5 lg:px-10 xl:px-16 relative overflow-hidden">
        {/* AMBIENT BACKGROUND */}
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background pt-[82px] relative overflow-hidden">
      {/* AMBIENT BACKGROUND */}
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div 
      ...
      <div className="w-full px-3 sm:px-5 lg:px-10 xl:px-16">
        <div className="flex gap-0 lg:gap-6 xl:gap-8">
          ...
          <aside className="hidden lg:flex flex-col w-[280px] xl:w-[320px] shrink-0 sticky top-[82px] self-start gap-4 pb-8">
            {/* Navigation Links */}
          ...
          <div className="w-full lg:flex-1 border-x border-foreground/[0.06] min-h-screen flex flex-col relative z-10">
            ...
            <div 
               ...
               className="sticky top-[82px] z-50 backdrop-blur-xl bg-background/80 border-b border-foreground/[0.06] px-5 py-3.5 flex items-center justify-between cursor-pointer active:opacity-80 transition-opacity"
            >
          ...
          <aside className="hidden lg:flex flex-col w-[280px] xl:w-[340px] shrink-0 sticky top-[82px] self-start gap-4 pb-8">
