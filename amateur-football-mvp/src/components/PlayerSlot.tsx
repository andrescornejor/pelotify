    ...
    if (!participant) {
        return (
            <div className="flex flex-col items-center gap-3 group cursor-not-allowed">
                ...
                <span className="text-[9px] font-black text-foreground/20 uppercase tracking-widest italic">Vacio</span>
            </div>
        );
    }
    ...
    return (
        ...
        >
            <div className={cn(
                ...
                isSelf ? "bg-primary shadow-[0_0_30px_rgba(16,185,129,0.3)]" : "bg-gradient-to-b from-foreground/10 to-transparent shadow-2xl"
            )}>
