        ...
        >
            ...
            <div
                ...
                style={{
                    ...
                    boxShadow: '0 30px 70px rgba(0,0,0,0.6), 0 0 0 1px rgba(16,185,129,0.1), inset 0 1px 0 rgba(16,185,129,0.15)',
                }}
            >
                {/* Texture overlay */}
                ...
                <motion.div
                    ...
                    style={{ background: 'radial-gradient(ellipse at 60% 30%, rgba(16,185,129,0.2) 0%, transparent 65%)' }}
                />
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-20">
                    <motion.div
                        ...
                        style={{ background: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.08), transparent)', transform: 'skewX(-20deg)' }}
                    />
                </div>
                ...
                <div 
                    ...
                    style={{ background: 'linear-gradient(to right, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.3) 50%, transparent 100%)' }}
                />
                ...
                <div className="absolute top-5 left-5 flex flex-col items-center z-30 gap-1 drop-shadow-2xl">
                    ...
                    <div className="flex flex-col items-center gap-1">
                        <span className="text-[9px] font-black text-primary uppercase tracking-[0.3em] border-t border-primary/50 pt-1 w-full text-center"
                        ...
                        <div className="mt-2 flex flex-col items-center gap-1 drop-shadow-lg">
                            <div className="flex -space-x-1">
                                {[...Array(Math.min(player.mvpTrophies, 3))].map((_, i) => (
                                    <Star key={i} className="w-3 h-3" style={{ color: '#f59e0b', fill: '#f59e0b', filter: 'drop-shadow(0 0 4px rgba(0,0,0,0.8))' }} />
                                ))}
                            </div>
                            <span className="text-[6px] font-black uppercase tracking-widest text-[#f59e0b]" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.8)' }}>MVP</span>
                        </div>
                    )}
                    ...
                    <div className="mt-2 flex flex-col gap-1.5">
                        {player.badges?.map((badge, i) => (
                            <div key={i} className="w-6 h-6 rounded-lg flex items-center justify-center relative hover:bg-black/40 transition-colors group/badge cursor-help shadow-lg"
                                style={{ background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(4px)' }}>
                                <Award className="w-3.5 h-3.5 text-primary-light" />
                                <div className="absolute left-full ml-1.5 px-2 py-1 rounded text-[7px] font-black text-white uppercase tracking-wider opacity-0 group-hover/badge:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50 shadow-2xl"
                ...
                >
                    <div className="relative w-full h-full">
                        <img
                            src={player.image || `https://api.dicebear.com/7.x/notionists/svg?seed=${player.name}&backgroundColor=transparent`}
                            alt={player.name}
                            className={cn(
                        ...
                        <div className="absolute inset-0 z-[-1]"
                            style={{ background: 'radial-gradient(circle at 60% 40%, rgba(0,0,0,0.4) 0%, transparent 70%)' }} />
                    </div>
                </div>
                ...
                <div className="absolute z-20" style={{ bottom: '108px', left: 0, right: 0 }}>
                    <div className="mx-5 py-2 text-center"
                        ...
                        <h3 className="text-base font-black italic text-white uppercase tracking-[0.1em] truncate px-2"
                ...
                <div className="absolute bottom-5 left-0 right-0 px-6 z-20">
                    <div className="grid grid-cols-2 gap-x-5 gap-y-1">
                        {[
                            ...
                            <div key={i} className="flex justify-between items-end pb-0.5 group/stat"
