    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-[100] lg:hidden pointer-events-none">
        ...
        <div className="relative pointer-events-auto w-full">
          <AnimatePresence>
            {isCreateMenuOpen && (
              <motion.div
                ...
                className="absolute bottom-[calc(78px+env(safe-area-inset-bottom,0px))] left-1/2 -translate-x-1/2 w-[280px] flex flex-col gap-3 py-4"
              >
                {[
          ...
          >
            <div className="relative z-10 flex w-full h-[calc(65px+env(safe-area-inset-bottom,0px))] items-center justify-around pt-0.5 pb-[env(safe-area-inset-bottom,0px)]">
              {navItems.map((item) => {
