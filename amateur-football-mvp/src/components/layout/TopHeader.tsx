...
export function TopHeader() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-[60] pt-[calc(1.5rem+env(safe-area-inset-top,0px))] sm:pt-6 lg:pt-4 px-3 sm:px-5 lg:px-10 xl:px-16 pointer-events-none">
