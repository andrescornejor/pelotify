              ...
              <div className="flex items-center gap-3 sm:gap-4 lg:gap-3 xl:gap-6 min-w-0">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col lg:gap-0.5">
                    ...
                    <span className="hidden sm:block lg:hidden 2xl:block text-[10px] sm:text-[10px] lg:text-[10px] font-black uppercase tracking-[0.3em] text-primary leading-none mt-0.5 group-hover/logo:drop-shadow-[0_0_8px_rgba(44,252,125,0.8)] transition-all duration-500 text-center">
                      DOMINA EL PROTRERO
                    </span>
                  </div>
                </Link>
