                ...
                <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 sm:p-6">
                    ...
                    >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <span className="text-[9px] font-black text-foreground/40 uppercase tracking-widest italic tracking-widest">Señal Encriptada</span>
                                    </div>
                                </div>
                            </div>
                            <button 
                        ...
                        <div className="flex-1 min-h-0">
                            <ChatRoom recipientId={recipientId} className="border-none rounded-none bg-transparent" />
                        </div>
                        ...
                        <div className="p-4 bg-foreground/[0.01] border-t border-foreground/5 flex items-center justify-center gap-2">
                            ...
                            <span className="text-[8px] font-black text-foreground/20 uppercase tracking-[0.3em]">Ambiente Seguro & Fair Play</span>
                        </div>
                    </motion.div>
                </div>
            )}
