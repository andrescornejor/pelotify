...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-primary selection:text-black font-sans scroll-smooth overflow-x-hidden">
      ...
      <nav className="fixed top-0 inset-x-0 h-28 z-[100] px-6 lg:px-12 flex items-center justify-between border-b border-primary/10 bg-[#050505]/80 backdrop-blur-3xl transition-all shadow-2xl">
         ...
         >
            {['Jugadores', 'Sedes', 'Ranking'].map((link) => (
               <Link key={link} href={link === 'Sedes' ? '/canchas/login' : `/login`} className="text-xs font-black uppercase tracking-[0.2em] text-zinc-400 hover:text-primary hover:drop-shadow-[0_0_10px_rgba(44,252,125,0.5)] transition-all">
                  {link}
               </Link>
            ))}
            <Link href="/login">
      ...
      {/* 🔴 NEW HERO SECTION: MASSIVE & GLOWING */}
         ...
         >
            ...
            >
               <Link href="/register" className="w-full sm:w-auto">
                  <button className="w-full h-20 px-16 bg-primary text-black font-black uppercase text-base tracking-[0.2em] rounded-3xl hover:bg-white hover:scale-105 active:scale-95 transition-all duration-500 flex items-center justify-center gap-4 shadow-[0_0_60px_rgba(44,252,125,0.5)] group relative overflow-hidden">
                     <div className="absolute inset-0 bg-white/20 translate-y-[100%] group-hover:translate-y-0 transition-transform duration-500" />
                     <span className="relative z-10">ENTRAR A LA CANCHA</span>
                     <ArrowRight className="w-7 h-7 relative z-10 group-hover:translate-x-3 transition-transform duration-500" />
                  </button>
               </Link>
               <Link href="/canchas/login" className="w-full sm:w-auto">
                  <button className="w-full h-20 px-12 border-2 border-white/20 text-white font-black uppercase text-base tracking-[0.2em] rounded-3xl hover:border-primary/80 hover:bg-[#0A0A0A] active:scale-95 transition-all duration-500 flex items-center justify-center gap-4 bg-black/60 backdrop-blur shadow-[0_20px_40px_rgba(0,0,0,0.5)] group hover:shadow-[0_0_40px_rgba(44,252,125,0.2)]">
                     <TargetIcon className="w-6 h-6 text-zinc-400 group-hover:text-primary transition-colors duration-500" />
      ...
      {/* 🔴 NUEVA SECCIÓN DE EXPLICACIÓN (DETAILED PLATFORM EXPLANATION CON ESTILO FIFA) */}
      <section className="py-40 px-6 lg:px-12 bg-[#020202] border-t border-white/5 relative overflow-hidden">
         {/* Background blur identical to Fifa card section */}
         ...
         <div className="max-w-[1500px] mx-auto flex flex-col lg:flex-row items-center gap-20 lg:gap-32 relative z-10">
            ...
            >
               ...
               <Link href="/register" className="inline-block pt-10">
                  <button className="h-20 px-12 bg-transparent border-2 border-primary text-white font-black uppercase text-base tracking-[0.2em] rounded-3xl hover:bg-primary hover:text-black hover:scale-105 active:scale-95 transition-all duration-500 flex items-center gap-4 group shadow-[0_0_40px_rgba(44,252,125,0.15)] hover:shadow-[0_0_60px_rgba(44,252,125,0.4)] relative overflow-hidden">
                     <div className="absolute inset-0 bg-primary/20 -translate-x-[100%] group-hover:translate-x-0 transition-transform duration-500" />
                     <span className="relative z-10">FORJAR MI CARTA AHORA</span>
                     <ChevronRight className="w-8 h-8 relative z-10 group-hover:translate-x-3 transition-transform duration-500" />
                  </button>
               </Link>
            </motion.div>
         ...
         <div className="max-w-[1500px] mx-auto rounded-[4rem] bg-[#0A0A0A] border border-white/5 p-10 md:p-16 lg:p-24 relative overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,1)] hover:border-primary/30 hover:shadow-[0_40px_100px_rgba(44,252,125,0.1)] transition-all duration-1000 group">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
               ...
               >
                  ...
                  <Link href="/canchas/login" className="inline-block pt-8">
                     <button className="px-14 h-24 bg-white text-black font-black uppercase text-lg tracking-[0.2em] rounded-3xl hover:bg-primary hover:scale-105 active:scale-95 transition-all duration-500 flex items-center gap-6 shadow-[0_20px_50px_rgba(255,255,255,0.1)] hover:shadow-[0_20px_60px_rgba(44,252,125,0.4)]">
