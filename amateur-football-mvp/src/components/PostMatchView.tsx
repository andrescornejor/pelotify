...
import { Trophy, Star, Users, MapPin, Calendar, Clock, Goal, ArrowRight, Medal, Crown, Shield, Check } from 'lucide-react';
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-16 relative z-10">
                        ...
                        <div className="flex flex-col items-center md:items-start gap-6 group/team">
                            <div className={cn(
                                ...
                                winner === 'A' ? "bg-blue-600 scale-105" : "bg-zinc-800 scale-100 grayscale opacity-60"
                            )}>
                                {winner === 'A' && (
                            ...
                            <div className="space-y-1 text-center md:text-left">
                                <h3 className="text-3xl font-black text-foreground italic uppercase tracking-tighter leading-none">Local</h3>
                                <div className="flex items-center gap-2">
                                    <div className={cn("w-2 h-2 rounded-full", winner === 'A' ? "bg-blue-500 animate-pulse" : "bg-foreground/20")} />
                                    <p className={cn("text-[10px] font-black uppercase tracking-[0.3em]", winner === 'A' ? "text-blue-500" : "text-foreground/40")}>
                        ...
                        <div className="flex flex-col items-center gap-8">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative px-10 py-3 bg-zinc-900/80 backdrop-blur-xl border border-primary/30 rounded-[2rem] shadow-2xl">
                                    <span className="text-[12px] font-black uppercase tracking-[0.5em] text-primary italic">FIN DEL ENCUENTRO</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center md:items-end gap-6 group/team">
                            <div className={cn(
                                "w-28 h-28 rounded-[2.5rem] flex items-center justify-center text-4xl font-black italic shadow-2xl transition-all duration-500 group-hover/team:scale-110 relative",
                                winner === 'B' ? "bg-red-600 scale-105" : "bg-zinc-800 scale-100 grayscale opacity-60"
                            )}>
                                {winner === 'B' && (
                            ...
                            <div className="space-y-1 text-center md:text-right">
                                <h3 className="text-3xl font-black text-foreground italic uppercase tracking-tighter leading-none">Visita</h3>
                                <div className="flex items-center gap-2 justify-center md:justify-end">
                                    <p className={cn("text-[10px] font-black uppercase tracking-[0.3em]", winner === 'B' ? "text-red-500" : "text-foreground/40")}>
                                        {winner === 'B' ? "EQUIPO GANADOR" : "SQUAD VISITANTE"}
                                    </p>
                                    <div className={cn("w-2 h-2 rounded-full", winner === 'B' ? "bg-red-500 animate-pulse" : "bg-foreground/20")} />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center justify-between mb-10 px-2">
                            <div className="flex items-center gap-5">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground/40 italic">Goles oficiales validados</p>
                                </div>
                            </div>
                            <div className="text-[10px] font-black text-foreground/20 uppercase tracking-widest border border-foreground/5 px-4 py-2 rounded-xl">TOTAL: {stats.goalScorers.reduce((acc, curr) => acc + curr.goals, 0)} GOLES</div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {stats.goalScorers.length > 0 ? (
                                    ...
                                    >
                                        <div className="flex items-center gap-5">
                                            ...
                                            <div className="space-y-0.5">
                                                <span className="font-black text-foreground uppercase italic tracking-tighter text-lg leading-none">{scorer.name}</span>
                                                <p className="text-[9px] font-black text-foreground/30 uppercase tracking-widest">Killer de Area</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3 bg-zinc-900 p-3 rounded-2xl border border-white/5">
                                            <span className="text-3xl font-black text-primary italic leading-none">{scorer.goals}</span>
                                ...
                                <div className="col-span-2 flex flex-col items-center justify-center py-16 gap-4 opacity-20 group/empty">
                                    ...
                                    <p className="text-sm font-black uppercase tracking-[0.4em] italic">Red en Cero · Sin Reportes</p>
                                </div>
                            )}
                        </div>
                    </motion.div>
                        ...
                        {(['A', 'B'] as const).map((team) => (
                            <div key={team} className={cn(
                                ...
                                <div className="flex items-center justify-between mb-10 relative z-10">
                                    <div className="space-y-1">
                                        <h3 className="text-xl font-black text-foreground italic uppercase tracking-tighter">Escuadra {team}</h3>
                                        <p className="text-[10px] font-black uppercase tracking-widest text-foreground/40">{team === 'A' ? teamA.length : teamB.length} Convocados</p>
                                    </div>
                                    <div className={cn(
                                        "w-12 h-12 rounded-2xl flex items-center justify-center font-black text-white italic",
                                        team === 'A' ? "bg-blue-600/20 text-blue-500 border border-blue-500/30 shadow-[0_0_20px_rgba(37,99,235,0.2)]" : "bg-red-600/20 text-red-500 border border-red-500/30 shadow-[0_0_20px_rgba(220,38,38,0.2)]"
                                    )}>
                                        {team}
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 relative z-10">
                                    {(team === 'A' ? teamA : teamB).map((p, idx) => (
                                        <div key={idx} className="flex items-center gap-4 p-3 rounded-2xl bg-foreground/[0.02] border border-white/5 hover:bg-foreground/[0.05] transition-all">
                                            <div className="w-10 h-10 rounded-xl bg-zinc-900 border border-white/10 flex items-center justify-center overflow-hidden shrink-0 shadow-lg">
                                                {p.profiles?.avatar_url ? (
                                                    ...
                                                    <span className="text-xs font-black text-foreground/20 italic">{p.profiles?.name?.[0].toUpperCase()}</span>
                                                )}
                                            </div>
                                            <div className="flex flex-col min-w-0">
                                                <span className="text-[11px] font-black text-foreground uppercase italic tracking-tighter truncate">{p.profiles?.name?.split(' ')[0]}</span>
                                                <span className="text-[8px] font-black text-foreground/30 uppercase tracking-[0.2em]">{p.profiles?.position || 'Jugador'}</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                ...
                <div className="lg:col-span-4 space-y-12">
                    ...
                    >
                        ...
                        <div className="relative z-10 space-y-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="space-y-0.5">
                                    <h2 className="text-2xl font-black text-foreground italic uppercase tracking-tighter text-primary">Man of Match</h2>
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground/40 italic">Votación popular</p>
                                </div>
                            </div>
                            ...
                            {stats.mvp ? (
                                <div className="flex flex-col items-center gap-10 py-6">
                                    <div className="relative">
                                        ...
                                        <div className="w-44 h-44 rounded-[2.8rem] bg-zinc-950 border-4 border-primary relative z-10 shadow-2xl group-hover:scale-105 transition-all duration-700 overflow-hidden">
                                            {stats.mvp.avatar_url ? (
                                                <img src={stats.mvp.avatar_url} alt="" className="w-full h-full object-cover" />
                                            ) : (
                                    ...
                                    <div className="text-center space-y-2">
                                        <h4 className="text-4xl font-black text-foreground italic uppercase tracking-tighter leading-none">{stats.mvp.name}</h4>
                                        <div className="flex items-center justify-center gap-3">
                                            <div className="h-[1px] w-8 bg-primary/30" />
                                            <p className="text-[11px] font-black uppercase tracking-[0.4em] text-primary italic">Figura Absoluta</p>
                                            <div className="h-[1px] w-8 bg-primary/30" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="py-16 flex flex-col items-center gap-6 text-center">
                                    ...
                                    <p className="text-xs font-black uppercase text-foreground/30 italic tracking-[0.4em]">Escrutinio Vacío</p>
                                </div>
                            )}
                        </div>
                    </motion.div>
                    ...
                    <div className="glass-premium rounded-[3.5rem] p-10 border border-foreground/10 space-y-8 relative overflow-hidden group/info">
                        ...
                        <div className="flex items-center gap-4 relative z-10 px-2">
                             ...
                             <h3 className="text-[11px] font-black uppercase tracking-[0.5em] text-foreground/40 italic">Resumen de Jornada</h3>
                        </div>
                        ...
                        <div className="space-y-4 relative z-10">
                            {[
                                ...
                                { icon: Shield, label: 'NIVEL', value: match.level || 'Competitivo', color: 'text-accent' }
                            ].map((item, idx) => (
                                <div key={idx} className="flex items-center justify-between p-5 rounded-[2rem] bg-foreground/[0.03] border border-white/5 hover:bg-foreground/[0.06] transition-all">
                                    <div className="flex items-center gap-5">
                                    ...
                                    <span className="text-sm font-black text-foreground uppercase italic tracking-tighter">{item.value}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="px-4">
                         ...
                         >
                            VOLVER AL TOP <ArrowRight className="w-4 h-4 -rotate-90 group-hover/scroll:-translate-y-1 transition-transform" />
                         </button>
                    </div>
                </div>
            </div>
