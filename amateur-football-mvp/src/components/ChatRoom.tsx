...
export default function ChatRoom({ matchId, recipientId, className, title }: ChatRoomProps) {
  ...
  return (
    ...
    >
      ...
      <div className="p-3 lg:p-4 pt-2 pb-[96px] lg:pb-4 relative z-20 bg-gradient-to-t from-white dark:from-[#0A0A0A] via-white/95 dark:via-[#0A0A0A]/95 to-transparent">
        <form
          onSubmit={handleSend}
