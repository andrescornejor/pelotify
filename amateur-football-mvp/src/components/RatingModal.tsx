        ...
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center px-4 pb-6 sm:p-6 pointer-events-auto">
          ...
          <motion.div
            ...
            style={{
              maxHeight: '88vh',
              background:
                'linear-gradient(145deg, rgba(var(--surface-elevated-rgb, 15,15,26),1), rgba(var(--surface-rgb, 8,8,15),1))',
              backgroundColor: 'var(--surface-elevated)',
              border: '1px solid rgba(var(--foreground-rgb),0.1)',
              borderRadius: '2rem',
              boxShadow:
                '0 40px 100px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.03) inset, 0 1px 0 rgba(255,255,255,0.06) inset',
            }}
          >
            {/* Top shimmer */}
            <div
              ...
              style={{
                background:
                  'linear-gradient(90deg, transparent, rgba(var(--foreground-rgb),0.15), transparent)',
              }}
            />
            ...
            <div
              ...
              style={{
                background: 'radial-gradient(circle, rgba(44,252,125,0.08) 0%, transparent 70%)',
              ...
              {submitted ? (
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, rgba(44,252,125,0.15), rgba(44,252,125,0.05))',
                  ...
                  {eloResult && (
                    ...
                    >
                      ...
                      <div
                        className={`rounded-2xl px-4 py-2.5 flex items-center justify-center gap-2 ${eloResult.change > 0 ? 'bg-green-500/10 border border-green-500/20' : 'bg-red-500/10 border border-red-500/20'}`}
                      >
                        <span
                          className={`text-sm font-black ${eloResult.change > 0 ? 'text-green-400' : 'text-red-400'}`}
                        >
                          {eloResult.change > 0 ? '+' : ''}
                  ...
                  <div className="px-6 pt-6 pb-4 pr-14 shrink-0">
                    <div className="flex items-center gap-3 mb-3">
                      <div
                        ...
                        style={{
                          background: 'rgba(44,252,125,0.1)',
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex justify-between items-center px-1">
                            {[1, 2, 3, 4, 5].map((star) => {
                              const isHovered =
                                hoveredStar?.id === player.id && hoveredStar.star >= star;
