  ...
  return (
    <Link href={`/establecimientos/${venue.id}`} className="block h-full">
      <motion.div
        ...
        className="group relative h-full glass-premium rounded-[3rem] p-4 border-white/5 hover:border-primary/40 transition-all duration-500 overflow-hidden flex flex-col shadow-2xl"
      >
        ...
        {/* Image Container */}
        <div className="relative h-64 sm:h-72 rounded-[2.5rem] overflow-hidden mb-6 shadow-inner border border-white/5">
          <img 
          ...
          <div className="absolute top-4 left-4 flex gap-2">
            <div className="px-4 py-2 glass rounded-2xl border border-white/10 shadow-2xl backdrop-blur-md">
